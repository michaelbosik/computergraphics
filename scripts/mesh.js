...
function mainMesh(){
    var canvas = document.getElementById('webglMesh');
    ...
    program = initShaders(gl, "vshaderMesh", "fshaderMesh");
    ...
    window.onkeypress = function(event){
        ...
        switch(event.key){
            ...
            case 'n': //Toggle movement modeMesh to 'cam' or 'mesh'
                if(modeMesh == 'mesh')
                    modeMesh = 'cam';
                else
                    modeMesh = 'mesh';
...
function killMesh(){
    ...
    gl = null;
    program = null;
    document.getElementById('cameraCoordinates').innerHTML= ("");
    document.getElementById('meshCoordinates').innerHTML= ("");
    document.getElementById('modeMesh').innerHTML= ("");
 ...
 * calls the renderMesh() method to begin animation
 */
...
/*
 * calculateNormalsMesh(i) - calculates the normal of the current polygon
 * using the newell method
 */
function calculateNormalsMesh(i){
...
function breathe(){
    ...
    for(i = 0; i < points.length; i+=3){     
       normals[i] = calculateNormalsMesh(i); //Calculate normals with Newell Method
    }
...
/*
 * renderMesh() - calculates translation, rotation, scaling of mesh and draws
...
function renderMesh(){
    ...
    //Determine where the camera should look based on camera look modeMesh
    var at; 
    ...
    id = requestAnimationFrame(renderMesh);
}

/*
 * writeHTMLMesh() - writes values of camera position, mesh position, modes and speed to the html document
 */
function writeHTMLMesh(){
    ...
    document.getElementById('cameraCoordinates').innerHTML= ("Camera Coordinates:</br><strong>X:</strong> " + camX 
                                                     + " <strong>Y:</strong>  " + camY 
                                                     + " <strong>Z:</strong>  " + camZ);
    document.getElementById('meshCoordinates').innerHTML= ("Mesh Coordinates:</br><strong>X:</strong>  " + midX 
                                                     + " <strong>Y:</strong>  " + midY 
                                                     + " <strong>Z:</strong>  " + midZ);
    document.getElementById('modeMesh').innerHTML= ("Current Mode: " + modeMesh + "</br>Camera Mode: " + cameraMode);
