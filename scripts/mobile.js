...
var modeMobile = "Gouraud"; //Shading modeMobile
...
function mainMobile(){
	canvas = document.getElementById('webglMobile');
	...
	program = initShaders(gl, "vshaderMobile", "fshaderMobile");
...
function killMobile(){
    ...
    gl = null;
    program = null;
    document.getElementById('shapes').innerHTML= ("Amount of shapes: " + 0);
    document.getElementById('angle').innerHTML= ("Cutoff Angle: " + 0);
}

/*
 * renderMobile() - renders shapes to the scene in heirarchal order
...
function renderMobile(){
    ...
    writeHTMLModule();
    id = requestAnimationFrame(renderMobile);
}
...
function draw(){
    ...
    if(modeMobile == "Gouraud")
        normals = shapes[currShape][NORMALS];
    else if(modeMobile == "Flat")
...
function newShape(){
    ...
    shapes[currShape][NORMALS] = calculateNormalsMobile();
...
/*
 * calculateNormalsMobile() - calculates the surface normals of a shape to the normals of the shape
 */
function calculateNormalsMobile(){
...
/*
 * writeHTMLModule() - writes all values to the html page
 */
function writeHTMLModule(){
    ...
    //document.getElementById('mode').innerHTML= ("Current Shading: " + modeMobile);
